...
import DroneShowStudio from './pages/DroneShowStudio';
import DroneReplayStudio from './pages/DroneReplayStudio';
import CarrierStation from './pages/CarrierStation';
      ...
      <main className="flex-1 overflow-y-auto bg-[#0b0f19]">
        <div className="p-6">
          <Routes>
            ...
            <Route path="/drone-show" element={<DroneShowStudio />} />
            <Route path="/replay" element={<DroneReplayStudio />} />
            <Route path="/carrier" element={<CarrierStation />} />
